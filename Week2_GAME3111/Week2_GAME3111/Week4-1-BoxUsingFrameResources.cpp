...
void TexWavesApp::BuildRenderItems()
{
	...
	//	XMMATRIX leftCylWorld = XMMatrixTranslation(-3.0f, 1.5f, -5.0f + i * 5.0f);
	//	XMMATRIX rightCylWorld = XMMatrixTranslation(+3.0f, 1.5f, -5.0f + i * 5.0f);

	//	XMMATRIX leftConeWorld = XMMatrixTranslation(-3.0f, 3.2f, -5.0f + i * 5.0f);
	//	XMMATRIX rightConeWorld = XMMatrixTranslation(+3.0f, 3.2f, -5.0f + i * 5.0f);
	...
	//	leftCylRitem->Mat = mMaterials["wirefence"].get();
	...
	//	rightConeRitem->IndexCount = rightConeRitem->Geo->DrawArgs["cylinder"].IndexCount;
